...
void tracking_step (MatrixXf X_orig,
    ...
    // test 2nd order
    ecpd_lle (X_orig, Y, sigma2, 0.5, 80000, 10, 0.05, 50, 0.00001, false, true, true, true, priors_vec, 0.5, "2nd order", occluded_nodes, 0.5, bmask_transformed_normalized, mat_max);
